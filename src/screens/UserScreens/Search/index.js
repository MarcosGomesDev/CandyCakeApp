...
const Search = () => {
    ...
    getLocation('user_location').then((data) => {if(data !== 'undefined') setLocation(data)})
        ...
        <Container>
            <View style={styles.header}>
                ...
                <TextInput
                    ...
                    onSubmitEditing={() => {
                        navigation.navigate('ResultSearch', {name: search, latitude: location.latitude, longitude: location.longitude})
                        setSearch('')
                    }}
                />
                {search.length >= 1 &&
